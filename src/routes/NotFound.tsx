...
export default function NotFound() {
  return (
    <div data-testid="page-404" className="mx-auto flex max-w-content flex-col items-center px-4 py-24 text-center">
      ...
      <h1 className="mt-2 text-h2 text-ink-900">Không tìm thấy trang</h1>
      <p className="mt-2 text-ink-500">Nội dung bạn tìm có thể đã được chuyển hoặc không tồn tại.</p>
